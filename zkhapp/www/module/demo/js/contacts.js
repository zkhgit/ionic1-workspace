angular.module('app')
    .controller('demoContactsCtrl',function($rootScope,$scope,$timeout,$location,$ionicScrollDelegate){
        $scope.vo = {
            contacts:[],
            aliasToast:false,
        ...
        $scope.vc = {
            ...
            selectAlias:function(event, index) {
                ...
                $timeout.cancel($scope.vo.toastTimer);
                $scope.vo.toastTimer = $timeout(function(){
