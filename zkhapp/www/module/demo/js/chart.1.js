angular.module('app')
    .controller('demoChartCtrl', function($rootScope,$scope,$interval,$timeout,$compile,$ocLazyLoad){
        (function init() {
            $scope.vo = {};
            function random(){
            ...
            $timeout(function(){
                var optionInterval = $interval(function(){
                        $timeout(function(){
                            $scope.vo.options = options[array[i]];
                            i++;
                        },1000);
                        if(i==array.length){
                            $interval.cancel(optionInterval);
                        }
                },3000);
            },1000);
