		...
		function($rootScope, $ionicModal, $timeout, CityPickerService, $ionicScrollDelegate) {
			return {
				...
				template: '<div class="{{::vm.cssClass}}">'+
							'<a item-click-ripple class="item {{::vm.iconPosition}}" href="#" ng-click="vm.showModal($event)">'+
				...
				link: function(scope, element, attrs) {
					var vm = scope.vm = {},
						...
						vm.iconClass = so.iconClass || 'positive ion-ios-location',
						...
						*/
						$ionicModal.fromTemplateUrl('component/ionic-pickcity/ionic.citypicker.html', {
							'scope': scope,
